  ...
  view(vnode: m.Vnode<NavbarAttributes>) {
    ...
    return m("nav.navbar", [
      ...
      m(".navbar-menu", { class: this.burgerActive ? "is-active" : "" }, [
        m(".navbar-end", [
          m("a.navbar-item", { href: "#!/profiles" }, m(Icon, { class: "fas fa-arrow-left" }, "Back to Profiles")),
          m("a.navbar-item", {
            onclick: toggleConnection,
            title: "Click to " + (isConnected ? "disconnect" : "connect")  // Hover text
          }, [
            m(Icon, { class: isConnected ? "fa-solid fa-circle" : "fa-regular fa-circle" }),  // circle icons
